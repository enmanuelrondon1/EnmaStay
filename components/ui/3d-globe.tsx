...
interface Globe3DProps {
  ...
  /** Marker externo a enfocar (ej. desde hover en una lista fuera del globo) */
  ...
  return (
    <>
      ...
      <OrbitControls
        ...
        rotateSpeed={0.4}
        autoRotate={config.autoRotateSpeed > 0 && !focusedMarker}
...
export function Globe3D({
  ...
  return (
    <div className={cn("relative w-full", className || "h-[500px]")}>
      <Canvas
        gl={{
          antialias: true,
          alpha: true,
